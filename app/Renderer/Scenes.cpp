...
void Renderer::LoadScene() {
  ...
  case Scenes::OneSphereScene: {
    ...
    // rectangle
    // m_scene.Add(Shapes::Rectangle({point3(-0.5, 0.5, 1), point3(0.5,0.5,0), point3(-0.5, -0.5, 0)}), material);
  ...
  case Scenes::Box3: {
    ...
    m_scene.Add(Shapes::Box3(point3(-1.5, 1.0, -2.0), point3(1.5, 0.0, -2.0)), material);
